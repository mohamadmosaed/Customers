...
<head>
    ...
    <title>📋  قائمة العملاء منتهي الدعم هذا اليوم</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="container p-6 bg-white rounded-lg shadow-lg border border-gray-200 w-100">
        ...
        <div class="flex justify-between items-center mb-4 bg-gray-50 p-4 rounded-md shadow-sm">
            ...
            <h2 class="text-2xl font-bold text-gray-700">📋 قائمة العملاء منتهي الدعم هذا  اليوم</h2>
...
<?php /**PATH C:\Customers\resources\views/reports/reportSupportEndThisDay.blade.php ENDPATH**/ ?>