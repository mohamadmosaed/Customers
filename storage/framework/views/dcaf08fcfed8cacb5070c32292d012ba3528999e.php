<section>
    <header>
        <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
            <?php echo e(__('معلومات الحساب')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__("قم بتحديث معلومات حسابك الشخصية وعنوان بريدك الإلكتروني.")); ?>
            ...
            <?php if($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail()): ?>
                <div>
                    <p class="text-sm mt-2 text-gray-800 dark:text-gray-200">
                        <?php echo e(__('لم يتم التحقق من عنوان بريدك الإلكتروني.')); ?>


                        <button form="send-verification" class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800">
                            <?php echo e(__('اضغط هنا لإعادة إرسال رابط التحقق.')); ?>
...
<?php /**PATH C:\Customers\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>