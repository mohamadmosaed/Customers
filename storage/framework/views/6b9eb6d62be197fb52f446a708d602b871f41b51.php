...
<body class="bg-gray-100 min-h-screen flex flex-col items-center justify-center">
    ...
    <div class="w-full max-w-4xl bg-white p-8 rounded-b-lg shadow-lg">
        <form id="activity-form" action="<?php echo e(route('activity.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#activity-form').submit(function(e) {
                ...
                $.ajax({
                    url: "<?php echo e(route('activity.store')); ?>",
                    method: "POST",
                    data: formData,
                    headers: {
...
<?php /**PATH C:\Customers\resources\views/activity/create.blade.php ENDPATH**/ ?>