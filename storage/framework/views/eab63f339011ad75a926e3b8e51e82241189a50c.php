...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    ...
    <div class="max-w-2xl w-full bg-white p-8 rounded-lg shadow-xl">
        ...
        <div class="bg-blue-50 p-6 rounded-lg border border-blue-300 shadow-sm">
            ...
            <p class="text-xl text-blue-700 font-bold"><?php echo e($activity->name); ?></p>
        </div>
        ...
        <div class="flex justify-center mt-6 space-x-3 space-x-reverse">
            ...
            <!-- Delete Button -->
            <form action="<?php echo e(route('activities.destroy', $activity->id)); ?>" method="POST" class="inline-block">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Customers\resources\views/activity/show.blade.php ENDPATH**/ ?>