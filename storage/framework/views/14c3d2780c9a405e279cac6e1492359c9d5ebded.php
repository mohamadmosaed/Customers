                ...
                <table class="w-full text-right border-collapse border border-gray-200 rounded-lg">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white hover:bg-gray-50 transition">
                            <td class="p-3 border border-gray-200"><?php echo e($item->customer_name); ?></td>
                            <td class="p-3 border border-gray-200"><?php echo e($item->mobile); ?></td>
                            <td class="p-3 border border-gray-200"><?php echo e($item->support_end); ?></td>
                            <td class="p-3 border border-gray-200"><?php echo e($item->customerAgent->name); ?></td>
                            <td class="p-3 border border-gray-200">
                                <?php if($item->support_end >= \Carbon\Carbon::today()): ?>
                            ...
                            <td class="p-3 border border-gray-200 text-center">
                                <button onclick="confirmNotification('<?php echo e(route('send-sms', $item->mobile)); ?>', '<?php echo e($item->mobile); ?>')"
...
<?php /**PATH C:\Customers\resources\views/NoticeCustomer/index.blade.php ENDPATH**/ ?>