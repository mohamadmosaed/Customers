...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-4xl p-8 bg-white rounded-lg shadow-lg">
        ...
        <!-- Form -->
        <form method="GET" action="<?php echo e(route('reportPerPeriodFilter')); ?>" class="space-y-6">
            <!-- Grid Layout -->
...
<?php /**PATH C:\Customers\resources\views/reports/reportPerPeriod.blade.php ENDPATH**/ ?>